function primo(){
    ...
    if(v1===v2){
        result.innerHTML = "<h2>Resultado</h2>" + "<h2>" + `${v1} é ${isEven(v1)} e ${isPositive(v1)}`
        + "</h2>" + "<h2>" + `${v1} ${isPrime(v1)}` + "</h2>" + "<h2>" + `Os números são Iguais` + "</h2>" 
    } else {
        result.innerHTML = "<h2>Resultado</h2>" + "<h2>" + `${v1} é ${isEven(v1)} e ${isPositive(v1)}` 
        + "</h2>" + "<h2>" + `${v2} é ${isEven(v2)} e ${isPositive(v2)}` + "</h2>" + "<h2>" 
        + `${v1} é ${isHigh(v1, v2)} que ${v2}` + "</h2>" + "<h2>" + `${v1} ${isPrime(v1)}` + "</h2>"
        + "<h2>" + `${v2} ${isPrime(v2)}` + "</h2>"
    }   
